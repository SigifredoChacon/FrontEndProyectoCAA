...
import { getAssets, deleteAsset, getAssetById } from '../../services/assetService.jsx';
...
// Componente para listar, buscar y administrar activos
// Props:
// - onEdit: función que se ejecuta al editar un activo
function AssetList({ onEdit }) {
    // Estados para almacenar la lista de activos, términos de búsqueda y resultados, y paginación
    ...
    // Llamada para cargar los activos al montar el componente
    useEffect(() => {
        fetchAssets();
    }, []);

    // Obtiene la lista de activos desde el servicio y la almacena en el estado
    ...
    // Función para manejar la eliminación de un activo tras la confirmación
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    ...
                    // Actualiza la lista de activos tras la eliminación
    ...
    // Maneja la búsqueda por número de placa y actualiza los resultados de la búsqueda
    ...
    // Define los activos que se mostrarán: todos o solo los resultados de búsqueda
    ...
    return (
        <Card style={{border: '0.5px solid #00000085', borderRadius: '12px', padding: '16px'}}>
            {/* Título de la lista de activos */}
            <Title>
                Activos
                {/* Muestra el número de activos en una insignia */}
                <Badge style={{
                    marginLeft: '8px',
            ...
            <Table className="mt-8">
                <TableHead>
                    <TableRow>
                        ...
                        <TableHeaderCell>Numero de serie</TableHeaderCell>
                ...
                <TableBody>
                    {/* Mapea los activos actuales para mostrar cada uno en una fila */}
