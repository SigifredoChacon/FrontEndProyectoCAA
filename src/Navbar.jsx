...
// Función que recibe una lista de clases y las une en un solo string, omitiendo valores falsy.
// Entrada: clases (array de strings o valores falsy)
// Salida: string con las clases concatenadas, separados por espacios.
...
function Navbar() {
    ...
    return (
        ...
        <Disclosure as="nav" className="border-t-8 border-[#EF3340]" style={{ backgroundColor: '#002855' }}>
            {({ open }) => (
                <>
                            ...
                            <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                                ...
                                <div className="hidden sm:ml-6 sm:block">
                                    <div className="flex space-x-4">
                                        {/* Itera sobre el array navigation para mostrar los enlaces de navegación según roles */}
                                        {navigation.map((item) => (
                                ...
                                <Menu as="div" className="relative ml-3">
                                    ...
                                    >
                                        <Menu.Items
                                            ...
                                            {/* Condición para mostrar la opción de iniciar sesión si no hay usuario */}
                                            {!user && (
                                                <Menu.Item>
                                                    {({active}) => (
                                                        <a
                    ...
                    {/* Panel de menú colapsable para dispositivos móviles */}
